...
class CanTuneConsumerPyramid extends Model
{
    /**
    ...
    protected $casts = [
        ...
        'status_submit_prosumer' => 'integer'
    ];
    ...
    public function getStatusAssessmentAllConsumer($event_id) 
    {
        $countNotAssessed = CanTuneConsumerPyramid::select(
    ...
    public function getStatusSubmitAllConsumer($event_id) 
    {
        $countNotAssessed = CanTuneConsumerPyramid::select(
            'can_tune_consumer_pyramids.event_member_class_id AS event_member_class_id',
            'users.id AS member_id',
            ...
            ->where('event_member_classes.class_grade_id', '=', 1)
            ->where('event_members.event_id', '=', $event_id)
            ->where('can_tune_consumer_pyramids.status_submit_prosumer', '=', 0)
            ->count();
